...
\providecommand*{\longrightarrowfill@}{%
  \arrowfill@\relbar\relbar\longrightarrow
}
\providecommand*{\longleftarrowfill@}{%
...
\newcommand{\xlongrightarrow}[2][]{\ext@arrow 0359\longrightarrowfill@{#1}{#2}}
\newcommand{\xlongleftarrow}[2][]{\ext@arrow 0359\longleftarrowfill@{#1}{#2}}
\makeatother

%THEOREMS
\newenvironment{Solution}
  {\ifshowsolutions\begin{tcolorbox}[colback=blue!8!white,colframe=blue!35!black,title=Solution]\fi}
  {\ifshowsolutions\end{tcolorbox}\fi}
